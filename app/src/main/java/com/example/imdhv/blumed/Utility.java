...
public class Utility {
    public static final String serverurl = "http://192.168.2.107/project1/androidsupport.php";
    ...
    public static void createdb(Context c){
        try{
            ...
            database.execSQL("CREATE TABLE IF NOT EXISTS MESSAGE (id integer primary key autoincrement,frommobile TEXT, tomobile text, data text, creationtime integer);");

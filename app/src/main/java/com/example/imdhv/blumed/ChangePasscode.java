...
public class ChangePasscode extends AppCompatActivity implements View.OnClickListener{
    ...
    public void onClick(View v) {
        if (!oldPass.getText().toString().isEmpty() && !newPass.getText().toString().isEmpty() && !newPassRepeat.getText().toString().isEmpty())
        {
            if (oldpass1 == 0) {
                oldpass1 = 1234;
            }
            if (oldpass1 == Integer.parseInt(oldPass.getText().toString())) {
                if (Integer.parseInt(newPass.getText().toString()) == Integer.parseInt(newPassRepeat.getText().toString())) {
                    if (newPass.getText().toString().length() > 8) {
                        Toast.makeText(this, "maximum length of passcode is 8", Toast.LENGTH_SHORT).show();
                    } else if (newPass.getText().toString().length() < 4) {
                        Toast.makeText(this, "minimum length of passcode is 4", Toast.LENGTH_SHORT).show();
                    } else {
                    ...
                    Toast.makeText(this, "Repeat passcode does not match", Toast.LENGTH_SHORT).show();
                }
            } else {
